...
export function CustomTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  return (
    ...
    <View style={[styles.outerWrapper, {
      ...
      {/*
        Shadow + overflow: 'hidden' live on the same element (BlurView).
        On iOS, shadow is drawn at the CALayer level, outside overflow bounds.
        On Android, elevation shadow is also drawn outside overflow bounds.
        This avoids the parent-shadow / child-overflow-hidden clipping pitfall.
      */}
      <BlurView
...
const styles = StyleSheet.create({
  ...
  pill: {
    ...
    overflow: 'hidden',
    // Shadow (iOS uses these; Android uses elevation below)
